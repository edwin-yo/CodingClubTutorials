...
\tightlist
\item
  fit a full model (he even recommends ``beyond optimal'' i.e.~more
  complex than you'd expect or want it to be)
\item
  sort out the random effects structure (use REML likelihoods or REML
  AIC or BIC)
\item
  sort out fixed effects structure (either use REML the F-statistic or
  the t-statistic or compare nested ML models - keep your random effects
  constant)
\item
