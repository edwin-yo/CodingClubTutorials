...
plot(ef_cPCOA, p.max = 0.05, col = 'blue', cex = 0.8)
```
...
orditorp(c_NMDS, display = 'species', col = 'red', air = 0.01)
orditorp(c_NMDS, display = 'sites', cex = 1.1, air = 0.01)
```
